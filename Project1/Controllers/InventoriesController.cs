...
{ 
    public class InventoriesController : Controller
    {
        ...
        public InventoriesController(RGProject1Context context)
        {
            _context = context;
        }
        ...
        {
            var rGProject1Context = _context.Inventory.Include(i => i.Location).Include(i => i.Product);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LocationId,ProductId,Stock")] Inventory inventory)
        {
            if (id != inventory.Id)
            {
                return NotFound();
